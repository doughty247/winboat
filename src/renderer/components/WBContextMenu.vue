...
// Global registry to track all open menus - ensures only one menu is visible at a time
const globalMenuRegistry = ((window as any).__WBContextMenuRegistry = (window as any).__WBContextMenuRegistry || new Set<() => void>())
...
const showMenu = (event: MouseEvent) => {
  ...
  globalMenuRegistry.forEach((closeMenu: () => void) => {
  ...
  globalMenuRegistry.add(hideMenu)
  emit('show')
...
const hideMenu = () => {
  ...
  globalMenuRegistry.delete(hideMenu)
  emit('hide')
